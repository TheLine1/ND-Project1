...
thresholds, color_thresh_img = f.threshold(200,200,200,img_color_orig)
...
# ROI - Four Side Polygone
# polygon_roi(img, shape, y_line, x_left, x_right)       
y_line  = 310
x_left  = 430
x_right = 530
masked_edges, color_thresholds_polygon, vertices = f.polygon_roi(img, shape, y_line, x_left, x_right, rgb_threshold)


# Mask color selection
color_select[color_thresholds | color_thresholds_polygon] = [0,0,0]

# Find where image is both colored right and in the region
line_image[~color_thresholds & color_thresholds_polygon] = [255,0,0]
...
#plot Images
images = [img,color_thresh_img,line_image,color_select, gray_img, \
...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr  7 14:47:23 2019
